...
export class GameController {
  ...
  @ApiResponse({ status: 201, description: 'New player registered', type: RegisterResponseDto })
  ...
  @ApiQuery({ name: 'userId', description: 'Player user ID', example: 'Player-ABC123' })
